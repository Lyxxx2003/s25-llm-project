...
results_df = pd.read_csv('../csv/zero_shot_results_df_1.csv')
...
metrics_genre_df.to_csv("../csv/zero_shot_evaluation_1_metrics_genre.csv", index=False)
metrics_mode_df.to_csv("../csv/zero_shot_evaluation_1_metrics_mode.csv", index=False)
